...
function messageSendToAddress($from_address, $to_address, $message, $template, $site_domain)
{
    ...
    if ($to_email_info == null && $to_telegram_info == null) {
        ...
        if ($to_email_info != null) {
            $body = fillTemplateFromObject($template, $to_email_info[name], $to_address, $to_email_info[lang], [message => $message]);
